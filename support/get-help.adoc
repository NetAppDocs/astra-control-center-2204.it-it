...
* https://netapppub.slack.com/#astra["*Richiedi assistenza tramite Slack*"^]: Vai al canale Containers nello spazio di lavoro Pub per entrare in contatto con colleghi ed esperti.
