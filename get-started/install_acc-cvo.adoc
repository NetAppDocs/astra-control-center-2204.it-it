...
* https://docs.openshift.com/container-platform/4.8/installing/installing_aws/installing-azure-default.html["Installazione del cluster OpenShift su Azure"^].
...
Seguire la documentazione di Azure per completare i seguenti passaggi. Vedere https://docs.openshift.com/container-platform/4.8/installing/installing_aws/installing-azure-default.html["Installazione del cluster OpenShift su Azure"^].
